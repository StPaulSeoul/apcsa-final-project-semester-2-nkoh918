...
public class Board extends JPanel implements ActionListener
{
	...
	public void draw(Graphics graphics)
	{
		if(alive == true)
		{
			...
			for (int i = 0; i < snake.Joints(); i++) 
			{
	            if (i == 0) 
	            {
	                graphics.setColor(Color.green);
	                graphics.fillRect(Snake.getSnakeX(i), Snake.getSnakeY(i), pixelsize, pixelsize);
	            } 
	            else {
	                graphics.fillRoundRect(Snake.getSnakeX(i), Snake.getSnakeY(i), pixelsize, pixelsize, 2, 2);
	            }
			}
	...
	public void NearFood() 
	{

	    if (Snake.getSnakeX(0) - food.getx() <= 20)
	    {
	    	if(Snake.getSnakeY(0) - food.gety() <= 20)
	    	{
	    		System.out.println("Food Joint");
	 	       
		        snake.setJoints(snake.Joints() + 1);
	...
	public static int getpixeltotal() {
		// TODO Auto-generated method stub
		return (height * width)  / (pixelsize * pixelsize);
	}
	
	public void collisioncheck() 
	{
	    if (snake.getSnakeY(0) >= height || snake.getSnakeY(0) < 0 || snake.getSnakeX(0) >= width || snake.getSnakeX(0) < 0) 
	    {
	        alive = false;
	    }
	    
	    for (int i = snake.Joints(); i > 0; i--) 
	    {
	        if ((i > 4) && (snake.getSnakeX(0) == snake.getSnakeX(i) && (snake.getSnakeY(0) == snake.getSnakeY(i)))) 
	        {
	            alive = false;
	        }
	    }
	...
	private void terminate(Graphics graphics) 
	{
		// TODO Auto-generated method stub
	...
	public void actionPerformed(ActionEvent e) {
	    if (alive) 
	    {
	        ...
	        System.out.println(snake.getSnakeX(0) + " " + snake.getSnakeY(0) + " " + food.getx() + ", " + food.gety());
	    }
	...
	public class Keys extends KeyAdapter 
	{
	    ...
	    public void keyPressed(KeyEvent e) 
	    {
	        ...
	        if ((key == KeyEvent.VK_LEFT) && (snake.moveright==false)) 
	        {
	        ...
	        if ((key == KeyEvent.VK_RIGHT) && (snake.moveleft==false)) {
	            snake.setmoveright(true);
	            snake.setmoveup(false);
	            snake.setmovedown(false);
	        }

	        if ((key == KeyEvent.VK_UP) && (snake.movedown==false)) {
	            snake.setmoveup(true);
	            snake.setmoveright(false);
	            snake.setmoveleft(false);
	        }

	        if ((key == KeyEvent.VK_DOWN) && (snake.moveup==false)) {
